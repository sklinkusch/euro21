...
import matches, { matchvf, matchhf, match3p, matchf } from "../../data/WorldCupWomen/matches_wwc2011"
...
function WWC11() {
  ...
  useEffect(() => {
    document.title = `${locales("WorldCup")} 2011`
  }, [])
  useEffect(() => {
    if (first[0]) {
      const aTeamVF1 = first[1].team || ""
      const bTeamVF1 = second[0].team || ""
