...
import matches, { matchaf, matchvf, matchhf, match3p, matchf  } from "../../data/WorldCupMen/matches_wc1998"
...
function WorldCup1998() {
  ...
  useEffect(() => {
    ...
    const aTeamAF6 = first[4]
    const bTeamAF6 = second[5]
    const teamsAF6 = [aTeamAF6, bTeamAF6]
    const aTeamAF7 = first[6]
    const bTeamAF7 = second[7]
  ...
  useEffect(() => {
    const aTeamVF1 = getKoTeams(matchaf, 0, first[1], second[0])
    const bTeamVF1 = getKoTeams(matchaf, 2, first[2], second[3])
    const teamsVF1 = [aTeamVF1, bTeamVF1]
    const aTeamVF2 = getKoTeams(matchaf, 1, first[0], second[1])
    const bTeamVF2 = getKoTeams(matchaf, 3, first[3], second[2])
    const teamsVF2 = [aTeamVF2, bTeamVF2]
    const aTeamVF3 = getKoTeams(matchaf, 5, first[4], second[5])
    const bTeamVF3 = getKoTeams(matchaf, 7, first[7], second[6])
    const teamsVF3 = [aTeamVF3, bTeamVF3]
    const aTeamVF4 = getKoTeams(matchaf, 4, first[5], second[4])
    const bTeamVF4 = getKoTeams(matchaf, 6, first[6], second[7])
