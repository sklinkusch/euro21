...
import matches, { matchaf, matchvf, matchhf, match3p, matchf  } from "../data/matches_wc2002"
import { TableSetEight } from "../components/Table"
import { AchtelfinaleWC02 } from "../components/Achtelfinale"
        ...
        <main sx={{ width: "100%" }}>
          ...
          />
           <div sx={{ display: "grid", gridTemplateColumns: ["repeat(2,1fr)", "repeat(2,1fr)", "repeat(4,1fr)"] }}>
            <AchtelfinaleWC02 first={first} second={second} matchaf={matchaf} />
