...
function WorldCup2023() {
  ...
  useEffect(() => {
    ...
    const aTeamVF4 = getKoTeams(matchaf, 5, first[1], second[3])
    const bTeamVF4 = getKoTeams(matchaf, 7, first[5], second[7])
