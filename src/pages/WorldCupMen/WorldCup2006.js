...
import matches, { matchaf, matchvf, matchhf, match3p, matchf  } from "../../data/WorldCupMen/matches_wc2006"
...
function WorldCup2006() {
  ...
  useEffect(() => {
    document.title = `${locales("WorldCup")} 2006`
  }, [])
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const aTeamVF3 = getKoTeams(matchaf, 2, first[1], second[0])
    const bTeamVF3 = getKoTeams(matchaf, 3, first[3], second[2])
