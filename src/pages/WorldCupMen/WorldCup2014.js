...
import matches, { matchaf, matchvf, matchhf, match3p, matchf  } from "../../data/WorldCupMen/matches_wc2014"
...
function WorldCup2014() {
  ...
  useEffect(() => {
    const aTeamVF1 = getKoTeams(matchaf, 4, first[4], second[5])
    const bTeamVF1 = getKoTeams(matchaf, 5, first[6], second[7])
