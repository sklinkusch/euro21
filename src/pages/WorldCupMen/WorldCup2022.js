...
import matches, { matchaf, matchvf, matchhf, match3p, matchf  } from "../../data/WorldCupMen/matches_wc2022"
...
function WorldCup2022() {
  ...
  useEffect(() => {
    ...
    const aTeamVF4 = getKoTeams(matchaf, 3, first[1], second[0])
    const bTeamVF4 = getKoTeams(matchaf, 2, first[3], second[2])
