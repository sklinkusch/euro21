...
import matches, { matchhf, matchf } from "../../data/EuroWomen/matches_weuro2005"
...
function WEuro05() {
  ...
  useEffect(() => {
    document.title = `${locales("Euro")} 2005`
  }, [])
  useEffect(() => {
  ...
  useEffect(() => {
    if (first[0]) {
      const aTeamHF1 = first[1].team || ""
      const bTeamHF1 = second[0].team || ""
      const teamsHF1 = [aTeamHF1, bTeamHF1]
      const aTeamHF2 = second[1].team || ""
      const bTeamHF2 = first[0].team || ""
